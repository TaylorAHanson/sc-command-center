          ...
          <div className="space-y-6 mt-6">
            <div>
              ...
              <ul className="list-disc pl-5 text-gray-700 space-y-2">
                ...
                <li><strong>Is Executable Action:</strong> Toggle this to indicate whether the widget performs an action (e.g., submitting a form). This is essential for telemetry collection. If your SQL data source changes data — INSERT, UPDATE, DELETE, MERGE — this is required, and saving is refused without it, because it's what puts the widget behind the confirmation prompt that records who approved the change and why.</li>
